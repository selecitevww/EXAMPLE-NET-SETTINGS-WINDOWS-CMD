...
-2: paging file size value=0MB, virus-rootkit use for loading in your(Windows) system this function default function. ( HARD LEVEL *****)
...
AFTER ..... RECOMANDATION GOTO ADMINISTRATOR WITH USUALY USER ACCESS.

EXAMPLE: SEE USER ACCOUNT "NET USER" IN CMD
...
15. VARIANT WORK WITH PROGRAM NETDISABLER, MAY BLOCK ALL RULE AND CONROL FIREWALL THIS PROGRAMM , DEFAULT ALL PROFILES BLOCK ALL INBOUND CONNECTIONS (INTERFACE SETTINGS) 
